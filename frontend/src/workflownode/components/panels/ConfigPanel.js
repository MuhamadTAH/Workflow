        ...
        <div className="main-panel" onClick={(e) => e.stopPropagation()}>
            <div className="panel-header">
                ...
                <div className="flex items-center">
                    ...
                    <button className="execute-step-btn" disabled={isLoading} onClick={handlePostData}>
                        {isLoading && node.data.type === 'whatsappTrigger' ? 'Waiting for WhatsApp...' : isLoading ? 'Loading...' : 'Webhook Step'}
                    </button>
                                ...
                                <div className="form-group">
                                    <button 
                                        ...
                                        style={{
                                            ...
                                            padding: '8px 16px',
                                            borderRadius: '4px',
                                            cursor: formData.accessToken && formData.phoneNumberId ? 'pointer' : 'not-allowed',
                                            opacity: formData.accessToken && formData.phoneNumberId ? 1 : 0.6,
                                            fontSize: '14px',
                                            marginBottom: '10px'
                                        }}
                                    >
